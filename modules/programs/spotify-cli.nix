    ...
    home-manager.users.${vars.username} = {
      ...
      home.file.".config/spotify-player/theme.toml" = {
        text = ''
          ...
          red = "${config.theming.colors.red}"
          green = "${config.theming.colors.green}"
          yellow = "${config.theming.colors.yellow}"
          blue = "${config.theming.colors.blue}"
          magenta = "${config.theming.colors.purple}"
          cyan = "${config.theming.colors.aqua}"
          white = "${config.theming.colors.fg2}"
          bright_black = "${config.theming.colors.bright-gray}"
          bright_red = "${config.theming.colors.bright-red}"
          bright_green = "${config.theming.colors.bright-green}"
          bright_yellow = "${config.theming.colors.bright-yellow}"
          bright_blue = "${config.theming.colors.bright-blue}"
          bright_magenta = "${config.theming.colors.bright-purple}"
          bright_cyan = "${config.theming.colors.bright-aqua}"
